...
export const products: Product[] = [
  {
    ...
    variations: [
      { id: '1-1', name: '1 Unidade', price: 299.90, stock: 5 },
      { id: '1-2', name: 'Kit 2 Unidades (Pague 1 e Meio)', price: 449.85, stock: 3 },
      { id: '1-3', name: 'Kit 3 Unidades (Leve 3 Pague 2)', price: 599.80, stock: 2 }
    ]
  },
  {
    id: '2',
    ...
    variations: [
      { id: '2-1', name: '1 Unidade', price: 459.00, stock: 3 },
      { id: '2-2', name: 'Kit Casal (2 Unidades)', price: 799.00, stock: 2 }
    ]
  },
  {
    id: '3',
